...
<body>
		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li {{(Request::is('/') ? ' class="active"' : '')}}><a href="{{{ URL::secure('') }}}">Accueil</a></li>
					<li {{(Request::is('contact') ? ' class="active"' : '')}}><a href="{{{ URL::secure('/contact') }}}">Contact</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right user-nav">
					...
					<li class="dropdown profile_menu">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="/simulations/mes-filtres">Mes filtres</a></li>
							<li class="divider"></li>
	...
	<div id="cl-wrapper" fixed-menu">
		@include('temp-simulations.layouts.sidebar')
		@yield('aside')
		<div class="container-fluid" id="pcont">
			...
			<div class="cl-mcont">
				...
				<p class="muted">
					...
					<small>Propulsé par <a href="http://www.laravel.com/" target="_blank">Laravel</a> | Mis en forme par <a href="http://getbootstrap.com/" target="_blank">Bootstrap</a> | Version {{Config::get('app.version')}}</small>
				</p>
			</div>
		</div>
	</div>
	...
	<?php /* {{ HTML::script('js/jquery.number/jquery.number.min.js') }} */ ?>
