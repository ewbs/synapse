...
<head>
<meta charset="utf-8" />
<title>@section('title') Synapse - Login @show</title>
	...
	<div id="cl-wrapper" class="login-container">
		...
		<div class="middle-login">
			<div class="block-flat">
				<div class="header">
					<h3 class="text-center">
						<img class="logo-img"
							src="{{{ secure_asset('images/logo.png') }}}" alt="logo" />Synapse
					</h3>
				</div>
				<div>
					...
					<form style="margin-bottom: 0px !important;"
						...
						<div class="foot">
							...
							<br />
							<a href="{{{ URL::secure('user/forgot') }}}">J'ai oublié mes
								identifiants</a>
						</div>
					</form>
				</div>
			...
			<div class="text-center out-links">
				<a href="http://www.ensemblesimplifions.be" target="_blank">eWBS
					2015</a>
			</div>
		</div>
	</div>
