	...
	<li>
		...
		<div class="content">
			<p>
				...
				@endif
				a modifié l'action à l'état en <strong>{{Lang::get( "admin/ewbsactions/messages.state.".$history->state)}}</strong> et de priorité {{EwbsActionRevision::graphicPriority($history->priority)}}
			</p>
			<hr/>
