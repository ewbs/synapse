...
@section('content')
    <div class="page-head">
        <h2><span class="fa fa-briefcase"></span> Documentation de la démarche <em>{{ $nostraDemarche->title }}</em></h2>
    </div>

    <div class="cl-mcont">


        {{-- Create Demarche Form --}}
        <form id="create-edit-demarche-form" method="post" action="{{ $modelInstance->routeGetEdit() }}" autocomplete="off" class="form-horizontal">
            ...
            <input type="hidden" name="nostra_demarche" value="{{$nostraDemarche->id}}"/>
                    ...
                    <div class="block-flat">
                        ...
                        <div class="content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="switch">
                                        <input type="checkbox" name="ewbs"
                                               {{{ Input::old('ewbs', isset($modelInstance) ? ($modelInstance->ewbs ? "checked" : "") : "") }}}/>
                                    </div>
                                </div>
                            </div>
                            <!-- ./ Périmetre eWBS -->
                            ...
                            @else
                                <div class="form-group {{{ $errors->has('eform_usage') ? 'has-error' : '' }}}">
                                    ...
                                    <div class="col-md-10">
                                        <input name="eform_usage" class="bslider form-control" type="text"
                    ...
                    <div class="block-flat">
                        ...
                        <div class="content">
                            ...
                            <div class="col-sm-11 col-sm-offset-1" id="docLinksContainer">
                                    ...
                                    @foreach($modelInstance->docLinks as $link)
                                        <div class="onedocLink">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10"><input name="docLinkTitle[]" class="form-control" type="text" placeholder="Nommez votre lien" value="{{$link->name}}"/></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">URL du lien</label>
                                                <div class="col-sm-10"><input name="docLinkURL[]" class="form-control" type="text" placeholder="Indiquez le lien (http(s); file:// ou autre)" value="{{$link->url}}"/></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Description</label>
                                                <div class="col-sm-10"><textarea name="docLinkDescription[]" name="docLink[]" class="form-control" placeholder="Explication éventuelle">{{$link->description}}</textarea>                                                </div>
                                            </div>
                                ...
                                @endif
                                {{--
                                    Les input sont volontairement en disabled sinon ils passent aussi dans le POST du formulaire et je ne le veux pas ne pas modifier cela.
                                    jQuery les enable quand nécessaire.
                                --}}
                                <div id="newLinkPattern" class="hidden">
                                    <div class="onedocLink">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Titre du lien</label>
                                            <div class="col-sm-10"><input disabled="disabled" name="docLinkTitle[]" class="form-control" type="text" placeholder="Nommez votre lien" value=""/></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">URL du lien</label>
                                            <div class="col-sm-10"><input disabled="disabled" name="docLinkURL[]" class="form-control" type="text" placeholder="Indiquez le lien (http(s); file:// ou autre)" value=""/></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Commentaire</label>
                                            <div class="col-sm-10"><textarea disabled="disabled" name="docLinkDescription[]" class="form-control" placeholder="Explication éventuelle"></textarea></div>
                                        </div>
                                        <a class="pull-right deleteDocLink"><span class="fa fa-remove"></span> supprimer ce lien</a>
                                        <div class="clearfix"></div>
                                        <hr/>
                            ...
                            ?>
                                @foreach($gains as $name=>$label)
                                        ...
                                        <div class="form-group {{{ $errors->has($name) ? 'has-error' : '' }}}">
                                            ...
                                            {{ $errors->first($name, '<span class="help-inline">:message</span><script type="text/javascript">var mustUnlockGains=true;</script>')}}
                                        </div>
