...
@section('title') Taxonomie sur Synapse	@parent @stop
					...
					<div class="block-flat">
						<div class="header">
							...
							@if (!$trash && $loggedUser->can('taxonomy_manage'))
								<div class="pull-right"><a href="{{ $model->routeGetCreate() }}" class="btn btn-small btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> Ajouter un tag</a></div>
							@endif
							<h3>Liste des tags @if ($trash) supprimés @endif</h3>
						</div>
						<div class="content">
