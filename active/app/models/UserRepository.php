...
class UserRepository {
	 ...
	 *
	 * @param array $input
	 *        	Array containing 'username', 'email' and 'password'.
	 *        	
	 ...
	 *
	 * @param array $input
	 *        	Array containing the credentials (email/username and password)
	 *        	
	 ...
	 * The $input['token'] will tell which user.
	 *
	 * @param array $input
	 *        	Array containing 'token', 'password' and 'password_confirmation' keys.
	 *        	
	 * @return boolean Success
	 */
